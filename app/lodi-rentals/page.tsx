...
export const metadata: Metadata = {
  title: "Electric Skid Steer Rental Lodi CA | Free Pickup",
  description:
    "Rent electric skid steers in Lodi, California. Free yard pickup, zero emissions, DVBE certified. Serving Sacramento, Stockton & Central Valley.",
  alternates: {
    canonical: "https://frontline.rentals/lodi-rentals",
  },
  openGraph: {
    title: "Electric Skid Steer Rental Lodi CA | Frontline",
    description:
      "Rent electric skid steers in Lodi with free yard pickup. Zero emissions, DVBE certified for government contractors.",
...
const jsonLd = {
  ...
  "@type": "LocalBusiness",
  name: "Frontline Equipment Rentals - Lodi",
  description:
    "Electric construction equipment rentals serving Lodi, Sacramento, and the Central Valley. DVBE certified, free yard pickup.",
  url: "https://frontline.rentals/lodi-rentals",
...
export default function LodiRentalsPage() {
  return (
    <>
        ...
        <Container className="relative">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="font-heading text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
              Electric Skid Steer Rental in Lodi, CA
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-xl text-white/80">
              Zero emission construction equipment for the Central Valley.
        ...
        <Container>
          <div className="mx-auto max-w-4xl">
            <h2 className="font-heading text-3xl font-bold tracking-tight text-foreground lg:text-4xl">
              Electric Equipment Rental for Lodi & Central Valley
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Our Lodi yard provides free pickup for contractors working throughout
              San Joaquin County, Sacramento, and the Central Valley. Electric skid
              steers are perfect for the region's warehouses, agricultural processing
              facilities, residential developments, and AQMD-regulated projects.
            </p>

            <div className="mt-10 grid gap-6 sm:grid-cols-2">
              {[
                "Free pickup from our Lodi yard",
                "Delivery available to Sacramento, Stockton, Modesto",
      ...
      <CtaBand
        headline="Ready to Rent in Lodi?"
