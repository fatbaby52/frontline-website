            ...
            <div className="flex flex-col items-center gap-6 text-center lg:flex-row lg:text-left">
              ...
              <div className="flex-1">
                ...
                <p className="mt-2 text-muted-foreground">
                  Frontline EV Rentals has electric skid steers in fleet, charged, tested, and ready for work. Contact us now to check current availability for Salinas and Monterey County jobs.
                </p>
              </div>
