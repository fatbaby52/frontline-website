...
export const equipment: Equipment[] = [
  {
    ...
    galleryImages: [
      { src: "/images/elise-1200.jpg", alt: "FirstGreen Elise 1200 Electric Skid Steer front view at Frontline EV Rentals" },
      { src: "/images/elise-1200-alt1.png", alt: "FirstGreen Elise 1200 Electric Skid Steer product cutout showing zero-emission design" },
      { src: "/images/elise-1200-alt2.png", alt: "FirstGreen Elise 1200 Electric Skid Steer operating on California job site" },
      { src: "/images/elise-1200-alt3.png", alt: "FirstGreen Elise 1200 Electric Skid Steer bucket attachment detail" },
    ],
  ...
  },
  {
    ...
    galleryImages: [
      { src: "/images/cbl-1200.jpg", alt: "FirstGreen CBL 1200 Electric Skid Steer front view available for rent in California" },
      { src: "/images/skid-steer-3.jpg", alt: "FirstGreen CBL 1200 Electric Skid Steer in action on construction site" },
    ],
